    ...
    <div className='mt-4 px-2 flex justify-center flex-wrap space-x-2'>
      {
        genres.map((genre) =>
          <button className={
            curGenre == genre ?
              'm-2 text-lg p-1 px-2 bg-blue-800 text-white rounded-xl font-bold' :
              'm-2 text-lg p-1 px-2 bg-gray-400 hover:bg-blue-800 hover:scale-110 text-white rounded-xl font-bold'
          }
            onClick={() => {
              setCurPage(1)
              setCurGenre(genre)
        ...
        <div className="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
          <div className="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-blue-50 min-w-full">
                <tr>
                  <th
                    scope="col"
                  ...
                  >
                    <div className='flex'>
                      <img src='https://img.icons8.com/external-those-icons-lineal-those-icons/24/000000/external-up-arrows-those-icons-lineal-those-icons-3.png' className='mr-1 cursor-pointer'
                        onClick={() => {
                          setPopularity(0)
                          setRating(-1)
                        }}
                      ...
                      <img src='https://img.icons8.com/external-those-icons-lineal-those-icons/24/000000/external-down-arrows-those-icons-lineal-those-icons-4.png' 
                        ...
                        className='ml-1 mr-2 hover-scale-110 cursor-pointer' />
                    </div>
                  </th>
                  <th
                    scope="col"
                  ...
                  >
                    <div className='flex'>
                      <img src='https://img.icons8.com/external-those-icons-lineal-those-icons/24/000000/external-up-arrows-those-icons-lineal-those-icons-3.png'
                        ...
                        className='mr-1 mr-2 cursor-pointer' />
                      Popularity
                      <img src='https://img.icons8.com/external-those-icons-lineal-those-icons/24/000000/external-down-arrows-those-icons-lineal-those-icons-4.png' className='ml-1 mr-2  cursor-pointer'
                        onClick={() => {
                          setRating(0)
                          setPopularity(1)
                        }}
                ...
                {filteredMovies.map((movie) => (
                  <tr key={movie.id}>
                    ...
                    <td className="px-4 py-4 whitespace-nowrap text-sm font-medium  ">
                      <button href="#" className="text-red-600/80 hover:text-red-900"
                        onClick={() => del(movie)}
                      >
                        Delete
                      </button>
